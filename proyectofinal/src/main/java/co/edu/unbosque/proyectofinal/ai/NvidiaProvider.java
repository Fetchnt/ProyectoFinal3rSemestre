...
public class NvidiaProvider implements AiProvider {
    ...
    public String traducir(String codigo, String lenguajeOrigen, String lenguajeDestino) {
        ...
        if (!origenValido) return "ERROR: Lenguaje de origen no soportado: " + lenguajeOrigen;
        if (!destinoValido) return "ERROR: Lenguaje de destino no soportado: " + lenguajeDestino;
