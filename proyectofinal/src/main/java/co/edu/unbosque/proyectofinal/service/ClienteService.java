...
public class ClienteService implements CRUDOPERATION<ClienteDTO> {
	...
	public String getAll() {
		...
		List<ClienteDTO> dtoList = entityList.stream().map(entity -> mapper.map(entity, ClienteDTO.class))
	...
	/**
	 * Genera un código aleatorio de 6 dígitos, lo asigna al cliente y envía el
	 * correo.
	 * 
